...
1. STRICT FACTUALITY: Extract ONLY the information present in the [Resume Content]. If missing, leave strings as "" and arrays as [].
...
4. DATA CONVERSION:
   - 'total_experience_months' MUST be calculated as an Integer (e.g., "5년 9개월" -> 69).
   - 'evaluation.internal_rating' MUST remain 0.
   - 'evaluation.one_line_review' MUST be generated by you. Synthesize the candidate's core strengths, total experience, main tech stack, and notable achievements into a professional, concise 1-2 sentence summary in Korean.
5. ENUMERATED VALUES (STRICT SELECTION):
   ...
   - 'skill_grad' MUST be exactly one of: ["상급", "중급", "하급"]. If unknown, leave as "".
